...
export default function Hero() {
  return (
    <section className="relative w-full h-[680px] mob:h-212.5 overflow-hidden">
      <div className="absolute inset-0">
        ...
        />
        <div
          className="absolute inset-x-0 top-0 w-full h-[408px] mob:h-51.5"
          style={{
            background:
      ...
      <div className="relative z-10 flex flex-col items-center w-full pt-[27px] mob:pt-7.5">
        <div className="flex items-center justify-center gap-4.5">
          ...
          />
          <p
            className="font-manege-demo text-white mob:text-[24px] text-center max-w-[clamp(195px,40vw+45px,500px)] mob:max-w-none"
            style={{ fontSize: "clamp(12px, 2.1vw + 5.3px, 24px)" }}
          >
        ...
        <Image
          ...
          width={90}
          height={90}
          className="mt-[129px] mob:mt-29.75 w-[74px] h-[74px] mob:w-22.5 mob:h-22.5"
        />

        <h1
          className="mt-[16px] mob:mt-8.5 uppercase text-white tracking-[-0.04em] leading-[1.2]"
          style={{ fontSize: "clamp(45px, 7.5vw, 104px)" }}
        >
          <span className="relative">
            <span className="font-cinzel">FLEU</span>
            <svg
              className="absolute right-0 pointer-events-none"
              style={{ width: "clamp(43px, 8.6vw + 14px, 101px)", height: "clamp(18px, 3.5vw + 7px, 42px)", top: "clamp(10px, 1.8vw - 3px, 15px)" }}
        ...
        <div className="flex flex-nowrap items-center gap-2 mob:gap-4 mt-[16px] mob:mt-4 mb-[32px] mob:mb-6">
          <span className="font-manege-demo font-light text-white text-[18px] mob:text-[36px] leading-[1.2] tracking-[-0.01em] whitespace-nowrap">
            Капитал
          </span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="4 0 37 37"
            fill="none"
            className="w-[20px] h-[20px] mob:w-[37px] mob:h-[37px]"
          >
            <path
        ...
        <p className="font-hanken text-white text-[15px] mob:text-[20px] leading-[1.35] mob:leading-[1.3] tracking-[-0.02em] max-w-[284px] mob:max-w-107.5 mb-[36px] mob:mb-8 text-center">
